...
ax.text(50,41.5,'Dynamic support extends the tested high-rate regime',ha='center',fontweight='bold',fontsize=11)
box(1,14,27,21,'Dense high-rate update','$1\\times$: 0.426\n$20\\times$: 0.340',P['raw'])
box(36.5,14,27,21,'Spine recipe','$\\lambda=0.1$\nper-step top 40%\ndynamic support',P['decon'])
box(72,14,27,21,'Measured outcome at 20×','Mean accuracy 0.445\n+0.0195 vs dense $1\\times$',P['spine'])
...
ax.text(50,2.5,'Three matched seeds in every factorial cell',ha='center',fontsize=7.7,color=P['body'])
