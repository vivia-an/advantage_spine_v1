...
fig, ax = plt.subplots(figsize=(5.65, 2.82))
...
ax.text(1.05, 0.429, "Dense 1×", fontsize=7.0, color=P["muted"])
ax.annotate("+0.0195 vs dense 1×",
            xy=(20, 0.445), xytext=(10.2, 0.467), ha="center", va="bottom",
            fontsize=7.4, color=P["accent"],
            arrowprops=dict(arrowstyle="->", color=P["accent"], lw=0.8))
ax.annotate("−0.086 vs dense 1×", xy=(20, 0.340), xytext=(11.7, 0.357), ha="center",
            fontsize=7.4, color=P["red"],
